        ...
        success: function (response) {
            ...
            $("#table").DataTable({
                ...
                columns: [
                    ...
                    {data: "TotalJugadores", title: "Total jugadores", class: "text-center"},
                    {data: "TotalGanadores", title: "Total ganadores", class: "text-center"},
                    {data: "MontoTotalApostado", title: "Monto total apostado", class: "text-center"},
                    {data: "MontoTotalPagado", title: "Monto total pagado", class: "text-center"},
                    {data: "Pleno", title: "Pleno", class: "text-center"},
