                ...
                columns: [
...

                    {
                        data: null, title: "Nro Ganador", class: 'text-center', "render": function (valor) {
                            ...
                            var ValorGanador = parseInt(valor.NroGanador);
                            var color_rgb = "";
                            var color_rgb_letra = "";
                            ...
                            return '<span class="badge" style="padding-top: 7px;padding-bottom: 7px; background-color: ' + color_rgb + '; color: ' + color_rgb_letra + '">' + valor.NroGanador + '</span>';
                        }
                    },
                    {
                        data: null, title: "Descripcion",
                        "render": function (value) {
                            return 'Número - ' + value.NroGanador + ' / ' + value.Descripcion;
                        }
                    }
                ],
