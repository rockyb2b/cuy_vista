(function ($) {
    $.fn.confeti = function(options) {
        ...
        window.w = canvas.width = elemento.width();
        window.h = canvas.height =elemento.height();
        window.resizeWindow = function() {
            window.w = canvas.width = elemento.width();//window.innerWidth;
            return window.h = canvas.height =elemento.height();// window.innerHeight
        };
        ...
        destruir=function(){
            ...
            $("#confeti_canvas",elemento).remove();
        ...
        window.step = function() {
            var a, b, c, d;
            animacion=requestAnimationFrame(step);
